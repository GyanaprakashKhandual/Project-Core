// Check the visibility of the claim functionality
describe('OrangeHRM', () => {
    it('Check the visibility of the claim functionality', () => {
        ...
        cy.xapth('//*[@id="app"]/div[1]/div[1]/header/div[1]/div[1]').click();
        cy.xpath('//*[@id="app"]/div[1]/div[1]/aside/nav/div[2]/ul/li[11]/a').should('have.text','Claims')
    });
});