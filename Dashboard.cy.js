// Checking the DashBoard section visibilty
describe('OrangeHRM', () => {
    it('Checking the DashBoard section visibilty', () => {
        ...
        cy.xpath('//*[@id="app"]/div[1]/div[1]/aside/nav/div[2]/ul/li[8]/a').click()
        cy.xpath('//*[@id="app"]/div[1]/div[1]/header/div[1]/div[1]').should('have.text','Dashboard')
    });
});